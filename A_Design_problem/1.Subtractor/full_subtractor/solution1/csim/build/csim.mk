...
HLS_SOURCES = ../../../../main.cpp ../../../../full_subtractor.cpp
...
$(ObjDir)/full_subtractor.o: ../../../../full_subtractor.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../full_subtractor.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/full_subtractor.d
