...
define weak void @"ALU::ALU_ALU::perform_operation"(i4* %A, i4* %B, i3* %op_code, i4* %result, i1* %carry_borrow) {
  ...
  call void @llvm.dbg.value(metadata !{i4* %A}, i64 0, metadata !57), !dbg !1993
  call void @llvm.dbg.value(metadata !{i4* %B}, i64 0, metadata !1994), !dbg !1993
  call void @llvm.dbg.value(metadata !{i3* %op_code}, i64 0, metadata !1995), !dbg !1993
  call void @llvm.dbg.value(metadata !{i4* %result}, i64 0, metadata !2011), !dbg !1993
  call void @llvm.dbg.value(metadata !{i1* %carry_borrow}, i64 0, metadata !2022), !dbg !1993
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 0, [13 x i8]* @p_str7, [2 x i8]* @p_str4, i32 0, i32 0, i4* %A) nounwind, !dbg !2036
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 0, [13 x i8]* @p_str7, [2 x i8]* @p_str5, i32 0, i32 0, i4* %B) nounwind, !dbg !2038
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 0, [13 x i8]* @p_str8, [8 x i8]* @p_str6, i32 0, i32 0, i3* %op_code) nounwind, !dbg !2039
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 1, [13 x i8]* @p_str7, [7 x i8]* @p_str9, i32 0, i32 0, i4* %result) nounwind, !dbg !2040
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 1, [7 x i8]* @p_str10, [13 x i8]* @p_str11, i32 0, i32 0, i1* %carry_borrow) nounwind, !dbg !2041
  call void (...)* @_ssdm_op_SpecProcessDef([4 x i8]* @p_str2, i32 0, [18 x i8]* @p_str3) nounwind, !dbg !2042
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([10 x i8]* @p_str13), !dbg !2043
  call void (...)* @_ssdm_op_SpecProtocol(i32 1) nounwind, !dbg !2044
  %val_V = call i3 @_ssdm_op_Read.ap_auto.volatile.i3P(i3* %op_code), !dbg !2045
  call void @llvm.dbg.value(metadata !{i3 %val_V}, i64 0, metadata !2064), !dbg !2045
...
; <label>:1                                       ; preds = %0
  %val_V_1 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2066
  call void @llvm.dbg.value(metadata !{i4 %val_V_1}, i64 0, metadata !2085), !dbg !2066
  %val_V_2 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %B), !dbg !2087
  call void @llvm.dbg.value(metadata !{i4 %val_V_2}, i64 0, metadata !2085), !dbg !2087
  %res_V = add i4 %val_V_2, %val_V_1, !dbg !2092
  call void @llvm.dbg.value(metadata !{i4 %res_V}, i64 0, metadata !2101), !dbg !2103
  %val_V_3 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2106
  call void @llvm.dbg.value(metadata !{i4 %val_V_3}, i64 0, metadata !2085), !dbg !2106
  %val_V_4 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %B), !dbg !2111
  call void @llvm.dbg.value(metadata !{i4 %val_V_4}, i64 0, metadata !2085), !dbg !2111
  %lhs_V = zext i4 %val_V_3 to i5, !dbg !2116
  call void @llvm.dbg.value(metadata !{i5 %lhs_V}, i64 0, metadata !2131), !dbg !2116
  %rhs_V = zext i4 %val_V_4 to i5, !dbg !2116
  call void @llvm.dbg.value(metadata !{i5 %rhs_V}, i64 0, metadata !2137), !dbg !2116
  %r_V = add i5 %rhs_V, %lhs_V, !dbg !2123
  call void @llvm.dbg.value(metadata !{i5 %r_V}, i64 0, metadata !2139), !dbg !2123
  %carry = call i1 @_ssdm_op_BitSelect.i1.i5.i32(i5 %r_V, i32 4), !dbg !2142
  call void @llvm.dbg.value(metadata !{i1 %carry}, i64 0, metadata !2395), !dbg !2115
  br label %._crit_edge, !dbg !2396

; <label>:2                                       ; preds = %0
  %val_V_5 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2397
  call void @llvm.dbg.value(metadata !{i4 %val_V_5}, i64 0, metadata !2085), !dbg !2397
  %val_V_6 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %B), !dbg !2402
  call void @llvm.dbg.value(metadata !{i4 %val_V_6}, i64 0, metadata !2085), !dbg !2402
  %res_V_1 = sub i4 %val_V_5, %val_V_6, !dbg !2407
  call void @llvm.dbg.value(metadata !{i4 %res_V_1}, i64 0, metadata !2101), !dbg !2416
  %val_V_7 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2417
  call void @llvm.dbg.value(metadata !{i4 %val_V_7}, i64 0, metadata !2085), !dbg !2417
  %val_V_8 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %B), !dbg !2422
  call void @llvm.dbg.value(metadata !{i4 %val_V_8}, i64 0, metadata !2085), !dbg !2422
  %carry_1 = icmp ult i4 %val_V_7, %val_V_8, !dbg !2427
  call void @llvm.dbg.value(metadata !{i1 %carry_1}, i64 0, metadata !2395), !dbg !2426
  br label %._crit_edge, !dbg !2430

; <label>:3                                       ; preds = %0
  %val_V_9 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2431
  call void @llvm.dbg.value(metadata !{i4 %val_V_9}, i64 0, metadata !2085), !dbg !2431
  %res_V_2 = add i4 %val_V_9, 1, !dbg !2436
  call void @llvm.dbg.value(metadata !{i4 %res_V_2}, i64 0, metadata !2101), !dbg !2445
  %val_V_10 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2446
  call void @llvm.dbg.value(metadata !{i4 %val_V_10}, i64 0, metadata !2085), !dbg !2446
  %carry_2 = icmp eq i4 %val_V_10, -1, !dbg !2451
  call void @llvm.dbg.value(metadata !{i1 %carry_2}, i64 0, metadata !2395), !dbg !2450
  br label %._crit_edge, !dbg !2462

; <label>:4                                       ; preds = %0
  %val_V_11 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2463
  call void @llvm.dbg.value(metadata !{i4 %val_V_11}, i64 0, metadata !2085), !dbg !2463
  %res_V_3 = add i4 %val_V_11, -1, !dbg !2468
  call void @llvm.dbg.value(metadata !{i4 %res_V_3}, i64 0, metadata !2101), !dbg !2471
  %val_V_12 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2472
  call void @llvm.dbg.value(metadata !{i4 %val_V_12}, i64 0, metadata !2085), !dbg !2472
  %carry_3 = icmp eq i4 %val_V_12, 0, !dbg !2477
  call void @llvm.dbg.value(metadata !{i1 %carry_3}, i64 0, metadata !2395), !dbg !2476
  br label %._crit_edge, !dbg !2479

; <label>:5                                       ; preds = %0
  %val_V_21 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2480
  call void @llvm.dbg.value(metadata !{i4 %val_V_21}, i64 0, metadata !2085), !dbg !2480
  %val_V_22 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %B), !dbg !2485
  call void @llvm.dbg.value(metadata !{i4 %val_V_22}, i64 0, metadata !2085), !dbg !2485
  call void @llvm.dbg.value(metadata !{i4 %val_V_21}, i64 0, metadata !2490), !dbg !2497
  call void @llvm.dbg.value(metadata !{i4 %val_V_22}, i64 0, metadata !2498), !dbg !2497
  %r_V_5 = and i4 %val_V_22, %val_V_21, !dbg !2497
  call void @llvm.dbg.value(metadata !{i4 %r_V_5}, i64 0, metadata !2500), !dbg !2497
  call void @llvm.dbg.value(metadata !{i4 %r_V_5}, i64 0, metadata !2101), !dbg !2503
  br label %._crit_edge, !dbg !2504

; <label>:6                                       ; preds = %0
  %val_V_23 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2505
  call void @llvm.dbg.value(metadata !{i4 %val_V_23}, i64 0, metadata !2085), !dbg !2505
  %val_V_24 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %B), !dbg !2510
  call void @llvm.dbg.value(metadata !{i4 %val_V_24}, i64 0, metadata !2085), !dbg !2510
  call void @llvm.dbg.value(metadata !{i4 %val_V_23}, i64 0, metadata !2515), !dbg !2519
  call void @llvm.dbg.value(metadata !{i4 %val_V_24}, i64 0, metadata !2520), !dbg !2519
  %r_V_6 = or i4 %val_V_24, %val_V_23, !dbg !2519
  call void @llvm.dbg.value(metadata !{i4 %r_V_6}, i64 0, metadata !2522), !dbg !2519
  call void @llvm.dbg.value(metadata !{i4 %r_V_6}, i64 0, metadata !2101), !dbg !2524
  br label %._crit_edge, !dbg !2525

; <label>:7                                       ; preds = %0
  %val_V_25 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2526
  call void @llvm.dbg.value(metadata !{i4 %val_V_25}, i64 0, metadata !2085), !dbg !2526
  %val_V_26 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %B), !dbg !2531
  call void @llvm.dbg.value(metadata !{i4 %val_V_26}, i64 0, metadata !2085), !dbg !2531
  call void @llvm.dbg.value(metadata !{i4 %val_V_25}, i64 0, metadata !2490), !dbg !2536
  call void @llvm.dbg.value(metadata !{i4 %val_V_26}, i64 0, metadata !2498), !dbg !2536
  %r_V_3 = and i4 %val_V_26, %val_V_25, !dbg !2536
  call void @llvm.dbg.value(metadata !{i4 %r_V_3}, i64 0, metadata !2500), !dbg !2536
  %res_V_6 = xor i4 %r_V_3, -1, !dbg !2537
  call void @llvm.dbg.value(metadata !{i4 %res_V_6}, i64 0, metadata !2101), !dbg !2544
  br label %._crit_edge, !dbg !2545

; <label>:8                                       ; preds = %0
  %val_V_27 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %A), !dbg !2546
  call void @llvm.dbg.value(metadata !{i4 %val_V_27}, i64 0, metadata !2085), !dbg !2546
  %val_V_28 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %B), !dbg !2551
  call void @llvm.dbg.value(metadata !{i4 %val_V_28}, i64 0, metadata !2085), !dbg !2551
  call void @llvm.dbg.value(metadata !{i4 %val_V_27}, i64 0, metadata !2556), !dbg !2560
  call void @llvm.dbg.value(metadata !{i4 %val_V_28}, i64 0, metadata !2561), !dbg !2560
  %r_V_7 = xor i4 %val_V_28, %val_V_27, !dbg !2560
  call void @llvm.dbg.value(metadata !{i4 %r_V_7}, i64 0, metadata !2563), !dbg !2560
  call void @llvm.dbg.value(metadata !{i4 %r_V_7}, i64 0, metadata !2101), !dbg !2565
...
._crit_edge:                                      ; preds = %8, %7, %6, %5, %4, %3, %2, %1, %0
  ...
  call void @llvm.dbg.value(metadata !{i4 %v_V}, i64 0, metadata !2567), !dbg !2575
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %result, i4 %v_V), !dbg !2580
  call void @llvm.dbg.value(metadata !{i1 %v}, i64 0, metadata !2591), !dbg !2598
  call void @llvm.dbg.value(metadata !{i1* %carry_borrow}, i64 0, metadata !2603), !dbg !2610
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %carry_borrow, i1 %v), !dbg !2612
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([10 x i8]* @p_str13, i32 %tmp), !dbg !2614
  ret void, !dbg !2615
}
...
define weak void @"ALU::ALU"(i4* %A, i4* %B, i3* %op_code, i4* %result, i1* %carry_borrow) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %result), !map !49
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %carry_borrow), !map !53
  call void @llvm.dbg.value(metadata !{i4* %A}, i64 0, metadata !2616), !dbg !2619
  call void @llvm.dbg.value(metadata !{i4* %B}, i64 0, metadata !2620), !dbg !2619
  call void @llvm.dbg.value(metadata !{i3* %op_code}, i64 0, metadata !2621), !dbg !2619
  call void @llvm.dbg.value(metadata !{i4* %result}, i64 0, metadata !2622), !dbg !2619
  call void @llvm.dbg.value(metadata !{i1* %carry_borrow}, i64 0, metadata !2623), !dbg !2619
  call void (...)* @_ssdm_op_SpecTopModule([4 x i8]* @p_str2, [4 x i8]* @p_str2) nounwind, !dbg !2624
  %ALU_ssdm_thread_M_perform_o = load i1* @ALU_ssdm_thread_M_perform_operation, align 1, !dbg !2626
  br i1 %ALU_ssdm_thread_M_perform_o, label %1, label %._crit_edge, !dbg !2626

; <label>:1                                       ; preds = %0
  call void @"ALU::ALU_ALU::perform_operation"(i4* %A, i4* %B, i3* %op_code, i4* %result, i1* %carry_borrow), !dbg !2627
  br label %._crit_edge, !dbg !2627

._crit_edge:                                      ; preds = %1, %0
  call void (...)* @_ssdm_op_SpecProcessDecl([4 x i8]* @p_str2, i32 0, [18 x i8]* @p_str3) nounwind, !dbg !2628
  call void (...)* @_ssdm_op_SpecSensitive([18 x i8]* @p_str3, [2 x i8]* @p_str4, i4* %A, i32 0) nounwind, !dbg !2629
  call void (...)* @_ssdm_op_SpecSensitive([18 x i8]* @p_str3, [2 x i8]* @p_str5, i4* %B, i32 0) nounwind, !dbg !2630
  call void (...)* @_ssdm_op_SpecSensitive([18 x i8]* @p_str3, [8 x i8]* @p_str6, i3* %op_code, i32 0) nounwind, !dbg !2631
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 0, [13 x i8]* @p_str7, [2 x i8]* @p_str4, i32 0, i32 0, i4* %A) nounwind, !dbg !2632
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 0, [13 x i8]* @p_str7, [2 x i8]* @p_str5, i32 0, i32 0, i4* %B) nounwind, !dbg !2633
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 0, [13 x i8]* @p_str8, [8 x i8]* @p_str6, i32 0, i32 0, i3* %op_code) nounwind, !dbg !2634
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 1, [13 x i8]* @p_str7, [7 x i8]* @p_str9, i32 0, i32 0, i4* %result) nounwind, !dbg !2635
  call void (...)* @_ssdm_op_SpecPort([4 x i8]* @p_str2, i32 1, [7 x i8]* @p_str10, [13 x i8]* @p_str11, i32 0, i32 0, i1* %carry_borrow) nounwind, !dbg !2636
  ret void, !dbg !2637
}
